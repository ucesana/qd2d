var JsHamcrest = {
    ...
    EqualTo: function(b) {
        return function(a) {
            return !JsHamcrest.isMatcher(a) ? b(JsHamcrest.Matchers.equalTo(a)) : b(a)
        }
    },
        ...
        if (b instanceof Array || a instanceof Array) {
            ...
            for (var c = 0; c < b.length; c++) {
                ...
                if (d instanceof Array || e instanceof Array) {
                    if (!JsHamcrest.areArraysEqual(d, e)) return !1
    ...
    areArraysEquivalent: function(b,
                                  a) {
        if (b.length !== a.length) return !1;
        for (var c = 0; c < b.length; c++)
            if (!1 === JsHamcrest.areTwoEntitiesEquivalent(b[c], a[c])) return !1;
        return !0
    },
    areMapsEquivalent: function(b, a) {
        return JsHamcrest.simpleMapCompare(b, a) && JsHamcrest.simpleMapCompare(a, b) ? !0 : !1
    },
    simpleMapCompare: function(b, a) {
        for (var c in b)
            if (b.hasOwnProperty(c) && !JsHamcrest.areTwoEntitiesEquivalent(b[c], a[c])) return !1;
        return !0
    },
    areTwoEntitiesEquivalent: function(b, a) {
        var c = JsHamcrest.retreiveEntityMatcherFunction(b),
            d = JsHamcrest.retreiveEntityMatcherFunction(a);
        return c === d && c(b, a) ? !0 : !1
    },
    retreiveEntityMatcherFunction: function(b) {
        return Array.isArray && Array.isArray(b) || b instanceof Array ? JsHamcrest.areArraysEquivalent : b instanceof Boolean ? JsHamcrest.areBooleansEqual : b instanceof Date ? JsHamcrest.areDatesEqual : b instanceof Function ? JsHamcrest.areFunctionsEqual : b instanceof Number || "number" === typeof b ? JsHamcrest.areNumbersEqual : b instanceof String || "string" === typeof b ? JsHamcrest.areStringsEqual : b instanceof RegExp ? JsHamcrest.areRegExpEqual : b instanceof Error ?
            JsHamcrest.areErrorsEqual : "undefined" === typeof b ? JsHamcrest.areEntitiesUndefined : null === b ? JsHamcrest.areEntitiesNull : b.constructor === Object ? JsHamcrest.areMapsEquivalent : JsHamcrest.areEntitiesStrictlyEquals
    },
    areBooleansEqual: function(b, a) {
        return b.toString() === a.toString()
    },
    areDatesEqual: function(b, a) {
        return b.toString() === a.toString()
    },
    areFunctionsEqual: function(b, a) {
        return b === a
    },
    areNumbersEqual: function(b, a) {
        return b.valueOf() === a.valueOf()
    },
    areStringsEqual: function(b, a) {
        return b.valueOf() === a.valueOf()
    },
    areRegExpEqual: function(b, a) {
        return b.toString() === a.toString()
    },
    areErrorsEqual: function(b, a) {
        return b.constructor === a.constructor && b.message === a.message
    },
    areEntitiesUndefined: function(b, a) {
        return b === a
    },
    areEntitiesNull: function(b, a) {
        return b === a
    },
    areEntitiesStrictlyEquals: function(b, a) {
        return b === a
    },
    ...
    CombinableMatcher: function(b) {
        JsHamcrest.SimpleMatcher.apply(this,
            arguments);
        b = b || {};
        this.and = function(a) {
...
JsHamcrest.Matchers.is = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            return b.matches(a)
        },
...
JsHamcrest.Matchers.not = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            return !b.matches(a)
        },
...
JsHamcrest.Matchers.both = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.CombinableMatcher({
        matches: b.matches,
        describeTo: function(a) {
...
JsHamcrest.Matchers.either = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.CombinableMatcher({
        matches: b.matches,
        describeTo: function(a) {
...
JsHamcrest.Matchers.hasItem = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            if (!(a instanceof Array)) return !1;
            for (var c = 0; c < a.length; c++)
                if (b.matches(a[c])) return !0;
            return !1
        },
        describeTo: function(a) {
...
JsHamcrest.Matchers.hasItems = function() {
    for (var b = [], a = 0; a < arguments.length; a++) b.push(JsHamcrest.Matchers.hasItem(arguments[a]));
    return JsHamcrest.Matchers.allOf(b)
};
JsHamcrest.Matchers.everyItem = JsHamcrest.EqualTo(function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            if (!(a instanceof Array)) return !1;
            for (var c = 0; c < a.length; c++)
                if (!b.matches(a[c])) return !1;
            return !0
        },
        describeTo: function(a) {
...
JsHamcrest.Matchers.isIn = function() {
    var b = JsHamcrest.Matchers.equalTo,
        a = arguments;
    a[0] instanceof Array && (a = a[0]);
    return new JsHamcrest.SimpleMatcher({
        matches: function(c) {
            for (var d = 0; d < a.length; d++)
                if (b(a[d]).matches(c)) return !0;
            return !1
        },
        describeTo: function(b) {
...
JsHamcrest.Matchers.hasSize = JsHamcrest.EqualTo(function(b) {
    var a = function(a) {
        var b = a.length;
...
JsHamcrest.Matchers.equivalentMap = function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            return JsHamcrest.retreiveEntityMatcherFunction(a) === JsHamcrest.areMapsEquivalent && JsHamcrest.retreiveEntityMatcherFunction(b) === JsHamcrest.areMapsEquivalent ? JsHamcrest.areMapsEquivalent(b, a) : !1
        },
        describeTo: function(a) {
            a.append("map equivalent to ").appendLiteral(b)
        }
    })
};
JsHamcrest.Matchers.equivalentArray = function(b) {
    return new JsHamcrest.SimpleMatcher({
        matches: function(a) {
            return b instanceof Array && a instanceof Array ? JsHamcrest.areArraysEquivalent(b, a) : !1
        },
        describeTo: function(a) {
            a.append("array equivalent to ").appendLiteral(b)
        }
    })
};
JsHamcrest.Operators = {};
JsHamcrest.Operators.filter = function(b, a) {
    if (!(b instanceof Array) || null == a) return b;
...
JsHamcrest.Operators.assert = function(b, a, c) {
    c = c ? c : {};
    var d = new JsHamcrest.Description;
...
JsHamcrest.Integration = function() {
    ...
    return {
        copyMembers: function(a, b) {
            if (1 == arguments.length) b = a, JsHamcrest.Integration.copyMembers(JsHamcrest.Matchers, b), JsHamcrest.Integration.copyMembers(JsHamcrest.Operators, b);
            else if (a)
        ...
        jsUnity: function(a) {
            a = a ? a : {};
            var b = a.scope || jsUnity.env.defaultScope;
            a = a.attachAssertions || !1;
            JsHamcrest.Integration.copyMembers(b);
...
"undefined" !== typeof exports && (exports.JsHamcrest = JsHamcrest);
